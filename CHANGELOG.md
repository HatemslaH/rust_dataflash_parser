...
- **Viewer:** chart zoom, pan, and selection overlay — correct coordinates on resize/HiDPI, no spurious scale reset, static graph while drag-selecting.

[0.3.1]: https://github.com/HatemslaH/rust_dataflash_parser/releases/tag/v0.3.1
